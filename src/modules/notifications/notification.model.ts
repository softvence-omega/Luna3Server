...
import { TEachNotification, TNotificationList } from "./notification.interface";
...
const notificationSchema = new Schema<TEachNotification>(
  ...
  export const NotificationModel = model<TEachNotification>('Notification', notificationSchema);